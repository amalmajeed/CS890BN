...
# Just a function to map character flag 'y' and 'n' to boolean flags True and False
def mp(x):
	if x == 'y':
		return True
	else:
...
# Function to compare the path trace lists from PRGA and IPRGA respectively
def diffr(l1,l2):
	# Reversing the IPRGA list for comparison as IPRGA progresses the states backwards from final state of PRGA
	l2.reverse()
	if(l1==l2):
